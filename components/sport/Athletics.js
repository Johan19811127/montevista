    ...
    <div className="max-w-8xl rounded-lg bg-white shadow-sm  p-2 md:p-5 flex flex-col md:flex-row text-indigo-600 mb-5">
      ...
      <ul className="list-disc	gap-2 px-5 ">
        ...
        <tbody>
          ...
          <tr>
          <td className="border border-indigo-400 px-2 py-1 leading-tight text-center">0/10 - 0/13  <p className="text-sm text-center">(Seniors)</p></td>
            <td className="border border-indigo-400 px-2 py-1 text-center"><p className="font-semibold">Mon, Wed &amp; Thurs </p> 14:45 – 15:45</td>
      
            <td className="border border-indigo-400 px-2 py-1">D Da Silva, M van der Merwe, R Koen, A Kleyn, A Williams, T Theron, J Ford, R Verwey &amp; L Janse van
Rensburg</td>
          </tr>
          </tbody>
          </table>
