...
export default function Sidebar() {
  ...
  return (
    <div className="relative">
      ...
      <div
        id="sidebar"
        className={`fixed top-0 left-0 h-screen w-72 bg-[#23468a] shadow-inner text-white z-20 transition-transform 
      ...
      <button
        ...
        className="md:hidden fixed top-4 left-4 bg-yellow-500 text-white p-2 rounded z-30"
      >
        ☰
      </button>
    </div>
