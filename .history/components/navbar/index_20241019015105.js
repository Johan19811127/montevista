    ...
    <header className="bg-white-950 border-b-4 border-slate-300 text-slate-800 ">
      <nav aria-label="Global" className="mx-auto flex  items-center justify-between p-6 lg:px-8 ">
        <div className="flex flex-row lg:flex-1">
          ...
          <Image alt="" width="50" height="60" src="/Badge.png" className="h-10  w-10 mr-5" />
        ...
        <a href="#" className="text-md font-semibold leading-6 text-gray-900">
          ...
          <Popover className="relative">
            <PopoverButton className="flex items-center gap-x-1 text-smd font-semibold leading-6 text-gray-900">
              Policies
