...
export default function Header() {
  ...
  return (
    <header className="bg-blue-300 text-white border-b-4 border-slate-300 text-slate-800 ">
      <nav aria-label="Global" className="mx-auto flex  items-center justify-between p-6 lg:px-8 ">
        <div className="flex flex-row lg:flex-1">
          <a href="#" className="flex flex-row items-center text-slate-800">
          <Image alt="" width="70" height="90" src="/Badge.png" className="h-10 -my-3 w-10 mr-5" />
        ...
        <a href="#" className="text-md font-semibold leading-6 text">
            Home
          </a>
