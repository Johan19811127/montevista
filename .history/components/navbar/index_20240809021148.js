...
export default function Header() {
  ...
  return (
    <header className="bg-white-950 border-b-4 border-slate-300 relative ">
      <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8 fixed top-0 left-0 right-0">
