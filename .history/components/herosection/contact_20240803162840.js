...
<div className="md:basis-2/6"><p className="contacttextsml text-dblue text-de lg:text-lg text-start" style={{lineHeight:'1.2'}}>Trading Hours :<br/><small className="subtext" style={{marginLeft:'0px'}}>(Clothing Store)</small></p></div>
