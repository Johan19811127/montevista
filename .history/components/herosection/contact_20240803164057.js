...
<div className="md;basis-1/6"><PhoneAndroidOutlinedIcon className="w-10 h-10 align-self-center" /></div>
<div className="md:basis-2/6"><p className=" text-default lg:text-lg font-bold text-dblue text-start ">Telephone :</p></div>
<div className="md:basis-3/6"><p className="text-default lg:text-mdf  text-dblue text-start"> <a href="tel:0215584637">(021) 558 4637</a></p></div>
</div>
