...
export default function Contact() {
  ...
  return (
    <div className=" flex h-screen">
        <div className="flex flex-col h-auto min-h container w-screen lg:w-[80%] lg:px-8  m-auto">
...
<div className="md:basis-1/3"><p className="contacttextsml text-dblue text-default font-bold lg:text-md text-start" style={{lineHeight:'1.2'}}><WatchLaterOutlinedIcon className="mr-2 md:w-9 md:h-9 align-self-center"/>Shop Hours:</p></div>
