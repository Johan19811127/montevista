...
export default function Intro() {
  return (
  <div className="container mx-auto h-screen lg:w-[80%] lg:px-8 flex justify-center align-center ">

 
  
     <div className="text-center my-auto ">
     <div className="container sml:w-90 ">
  <Image src="/60Badge.png" width="400" height="160" className=" self-center mx-auto mb-4" alt="In 2023 Monte Vista Primary School celebrated its 60th anniversary"></Image>
  </div>
     <h3 className="text-2xl font-bold tracking-tight text-slate-700 md:text-4xl">
     Welcome to
       </h3>
       <h3 className="text-3xl font-bold tracking-tight text-slate-800 md:text-6xl">
      Monte Vista Primary School
       </h3>
       <div className="text-justify px-3 md:px-1">
