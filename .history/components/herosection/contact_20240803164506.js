...
<div className="md:basis-2/6"><p className=" text-default lg:text-md font-bold text-dblue text-start "><PhoneAndroidOutlinedIcon className=" w-8 md:w-10 h-8 md:h-10 align-self-center" />Telephone :</p></div>
