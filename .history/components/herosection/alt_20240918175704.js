...
const HeroSection = () => {
  ...
  return (
    <div className="flex flex-col justify-content-center align-items-center content-center items-center h-screen md:max-w-[1200px] py-12 md:py-8 lg:py-5 mx-auto">
