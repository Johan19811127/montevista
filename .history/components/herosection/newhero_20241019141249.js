...
export default function NewHero() {
 ...
 <>
      ...
      <Image
            ...
            width={300}
            height={400}
            className="drop-shadow-lg w-[50%] max-w-[50vw] lg:h-[800px] lg:w-[600px] mx-auto text-center"
          />
      </div>
      <div className="w-full md:basis-1/2 align-items-center h-full flex flex-col justify-items-center">
          <h2 className="text-4xl font-semibold text-slate">What Makes Us Different?</h2>
