...
<div className="lg:basis-3/6 text-center w-full p-5 md:p-4">
<Image src="/contactus.png" width="600" height="900" alt="contact us at Monte Vista Primary School" className="mx-auto w-[50%] lg:w-[70%]"/>
