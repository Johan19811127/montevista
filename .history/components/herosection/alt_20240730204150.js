...
const HeroSection = () => {
  ...
  return (
    <div className="relative flex flex-col justify-between h-screen md:flex-row">
      <div className="flex my-auto mxmd:w-1/2 pl-8 max-w-screen-md bg-white bg-opacity-75">
        <div className="text-center mx-auto">
          ...
          <p className="text-lg mb-4 mx-5 text-dblue font-bold leading-tight mt-8">
