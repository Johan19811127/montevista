...
export default function NewHero() {
 ...
 <>
        ...
        <div className="container my-auto mx-auto h-auto py-3 px-2  lg:px-8 h-auto min-h-screen flex flex-col justify-center align-center content-center items-center ">
       
        <Image src="/hero.png" width="1000" height="600" alt="Monte Vista Primary School" className="w-[75%] mx-auto"></Image>
         <div className="w-full md:basis-1/4 align-items-center h-full flex flex-row justify-items-center"></div>
        <div className="w-full md:basis-1/2 align-items-center flex flex-row justify-items-center">
        ...
        <div className="container mx-auto min-w-[300px] w-[60%]"></div>
          <p className="font-semibold leading-tight p-3 text-center">
