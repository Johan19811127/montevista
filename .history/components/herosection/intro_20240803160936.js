...
export default function Intro() {
  return (
  <div className="container mb-3 mx-auto h-screen lg:w-[80%] lg:px-8 h-auto min-h-screen flex justify-center align-center ">

 
  
     <div className="text-center my-auto ">
     <div className="container sml:w-90 ">
  <Image src="/60Badge.png" width="400" height="160" className=" self-center max-w-40 mx-auto mb-4" alt="In 2023 Monte Vista Primary School celebrated its 60th anniversary"></Image>
  </div>
