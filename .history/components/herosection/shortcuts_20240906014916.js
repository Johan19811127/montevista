...
export default function Shortcuts() {
  return (
    <div className="flex flex-col h-auto min-h-screen container w-screen lg:w-[80%] content-center items-center lg:px-8  m-auto ">
