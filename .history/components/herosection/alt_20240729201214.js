...
const HeroSection = () => {
  return (
    <div className="relative flex flex-col size-full md:flex-row h-screen">
      <div className="flex items-center  justify-center md:w-1/2  max-w-screen-md bg-white bg-opacity-75 p-10">
      ...
      <div className="md:w-1/2  max-w-screen-md bg-white bg-opacity-75 p-10">
              <div className="mt-10">
