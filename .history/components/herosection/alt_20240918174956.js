...
const HeroSection = () => {
  ...
  return (
    <div className="relative flex flex-col content-center items-center h-screen md:max-w-[1200px] py-5 mx-auto">
        ...
        <Image src="/Hero.png" width="1600" height="800" alt="Welcome to Monte Vista Primary School" className="rounded-xl my-14 md:my-8 lg:my"></Image>
   
          <div className="container  w-[90%] md:w-[80%] lg:w-[70%] text-justify  mx-auto lg:text-center">
