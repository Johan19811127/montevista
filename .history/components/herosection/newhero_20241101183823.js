...
export default function NewHero() {
 ...
 <>
        ...
        {/* Section 1 */}
        <div className="container my-auto mx-auto h-auto py-6 px-2  lg:px-8 h-auto min-h-screen flex flex-col-reverse  md:flex-row justify-center align-center content-center items-center ">
       ...
       <Image src="/hero.png" width="1000" height="600" alt="Monte Vista Primary School" className="lg:w-full hidden lg:d-block "></Image>
