    ...
    <div className="relative flex flex-col justify-start md:justify-between h-screen md:flex-row bg-no-repeat bg-cover backcell lg:backhero bg-right-bottom">
      <div className="flex md:my-auto mx-auto md:w-1/2 md:ml-8 ">
        <div className="text-center mx-auto">
          <Image src="/School badge - own.png" width="250" height="500" className="w-1/5  mtmd:w-1/3 mx-auto mb-4" alt="School Badge" />
          <h1 className="text-3xl font-bold text-dblue leading-none md:text-5xl">Monte Vista Primary School</h1>
        
          <Image src="/Proud.png" className="mx-auto max-w-[60%]" width="600" height="120" alt="Be proud / Wees Trots"></Image>
