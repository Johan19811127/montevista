 ...
 <>
      <div className=" flex-col-reverse flex md:flex-row p-2 lg:p-5 h-full">
        ...
        <div className="container m-auto">
          <h1 className="lg:text-8xl text-3xl leading-tight text-blue-950 lg:font-black mb-0 font-bold text-center">Monte Vista</h1>
          <h2 className="text-2xl md:text-6xl font-semibold text-blue-700 text-center mt-0">Primary School</h2>
