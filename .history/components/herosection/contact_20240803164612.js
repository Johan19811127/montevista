...
<div className="md:basis-1/4"><p className=" text-default lg:text-md font-bold text-dblue text-start "><PhoneAndroidOutlinedIcon className="mr-3  w-8 md:w-9 h-8 md:h-10 align-self-center" />Telephone :</p></div>
