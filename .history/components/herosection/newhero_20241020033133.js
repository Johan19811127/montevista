...
export default function NewHero() {
 ...
 <>
        ...
        <div className="w-full md:basis-1/2 align-items-center h-full flex flex-row justify-items-center"></div>
        ...
        <SpinningLogo></SpinningLogo>
          <h1 className="text-3xl leading-tight text-slate-800 font-bold mb-4 font-bold text-center">Monte Vista Primary School</h1>
