...
<Image src="/contactus.png" width="600" height="900" alt="contact us at Monte Vista Primary School" className="mx-auto w-[50%] lg:w-[90%]"/>

</div>
<div className="lg:basis-4/6 text-center my-auto w-full p-5 md:p-8">
