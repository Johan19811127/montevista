...
<div className="md:basis-1/3"><p className=" text-xl lg:text-md font-bold text-dblue text-start "><PhoneAndroidOutlinedIcon className="mr-3  md:w-9 md:h-9 align-self-center" />Telephone :</p></div>
