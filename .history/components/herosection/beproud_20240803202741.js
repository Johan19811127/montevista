...
export default function Beproud() {
  return (
  <div className="container my-auto mx-auto h-auto min-h-screen py-4 px-2 lg:w-[80%] lg:px-8 h-auto min-h-screen flex justify-center align-center ">

 
  
     <div className="text-center my-auto ">
     <div className="container  ">
     <Image src="/throthy.png" width="4600" height="600" className="float-left " alt="be proud / wees trots"></Image>
