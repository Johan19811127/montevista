  ...
  return (
    <div className="p-3 flex flex-row min-h-screen w-100 ">
      ...
      <div className="container mt-10 mx-auto w-2/3">
        ...
        <p className="text-lg text-dblue text-center leading-tight  font-bold "> Our site is designed with user convenience in mind, offering quick and easy access to popular information you might need. Use the navigation links below to explore various sections, including Academics, Admissions, School Calendar, Extracurricular Activities, and Parent Resources. Whether you are looking for detailed information on our curriculum, interested in enrolling your child, or seeking the latest school news and events, these links will guide you directly to your destination. Navigate effortlessly and discover what makes Monte Vista Primary School a nurturing and dynamic environment for young learners.</p>
        </div>
