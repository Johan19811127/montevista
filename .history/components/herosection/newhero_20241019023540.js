...
export default function NewHero() {
  return (
 <>
      <div className=" flex-col-reverse flex md:flex-row lg:gap-8 p-2 lg:p-5 h-full">
        {/* Section 1 */}
        <div className="w-full md:basis-1/2 align-items-center h-full flex flex-row justify-content-center">
        <div className="container m-auto">
          <h1 className="lg:text-6xl text-3xl leading-tight text-blue-500 lg:font-black mb-0 font-bold text-center">Monte Vista</h1>
