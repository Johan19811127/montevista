...
export default function Intro() {
  ...
  <Image src="/60Badge.png" width="500" height="200" className=" self-center mx-auto mb-4" alt="In 2023 Monte Vista Primary School celebrated its 60th anniversary"></Image>
  </div>
