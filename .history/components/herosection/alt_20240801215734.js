    ...
    <div className="relative flex flex-col justify-between h-screen md:flex-row backhero bg-right-bottom">
      <div className="flex my-auto mx-auto md:w-1/2 pl-8 max-w-screen-md ">
        <div className="text-center mx-auto">
          ...
          <h1 className="text-5xl font-bold text-dblue leading-none mx-auto">Monte Vista Primary School</h1>
        
          <Image src="/Proud.png" width="600" height="120" alt="Be proud / Wees Trots"></Image>
