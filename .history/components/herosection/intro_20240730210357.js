...
export default function Intro() {
  return (
  <div className="container mx-auto h-screen  flex justify-center align-center ">

 
  
     <div className="text-center my-auto ">
     <div className="container w-90 ">
  <Image src="/60Badge.png" width="400" height="200" className=" self-center mx-auto mb-4" alt="In 2023 Monte Vista Primary School celebrated its 60th anniversary"></Image>
  </div>
