...
<div className="card flex flex-col p-4 rounded-xl shadow-xl  border-2 border-slate-200 self-normal">
    ...
    <p className="text-default text-dblue text-center leading-tight text-md m-5">Navigate our comprehensive list of policies at Monte Vista Primary School, thoughtfully crafted to ensure a safe, respectful,</p>
</div>
