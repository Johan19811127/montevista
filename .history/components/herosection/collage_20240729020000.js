export default function Collage() {
    return (
      <div className="relative h-screen overflow-hidden bg-white">
        <div className="pb-80 h-90 justify-stretch items-stretch pt-16 sm:pb-40 sm:pt-24 lg:pb-60 lg:pt-40">
       ...
       <p className="mt-6 text-base leading-tight text-slate-700 text-center">
