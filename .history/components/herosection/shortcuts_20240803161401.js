...
export default function Shortcuts() {
  return (
    <div className="p-3 flex flex-col container mb-3 mx-auto h-screen py-4 px-3 lg:w-[80%] lg:px-8 h-auto min-h-screen flex justify-center align-center ">
      
        <h1 className="text-2xl font-bold tracking-tight text-dblue lg:text-6xl mb-5 text-center">Quick Links</h1>
    
        <p className=" text-defualt lg:text-lg text-dblue text-center leading-tight   text-justify"> Our site is designed with user convenience in mind, offering quick and easy access to popular information you might need. Use the navigation links to explore various sections, including Academics,Extracurricular Activities, Our Fees or Admissions. </p>
        <p className=" text-defuialt lg:text-lg text-dblue text-center leading-tight  mt-5 mb-5 text-justify "> Whether you are looking for detailed information on our curriculum, interested in enrolling your child, or seeking the latest school news and events, these links will guide you directly to your destination. Navigate effortlessly and discover what makes Monte Vista Primary School a nurturing and dynamic environment for young learners.</p>
...
<div className="card flex flex-col p-4 rounded-xl shadow-xl  border-2 border-slate-200 self-normal">
    ...
    <Image src="/meet the team.png" width="140" height="140" className="mx-auto mb-2 " alt="Meet the team"></Image>
