...
<div className="md:basis-1/4"><p className="contacttextsml text-dblue font-bold text-default  lg:text-md text-start" style={{lineHeight:'1.2'}}><BusinessOutlinedIcon className="mr-2 md:w-9 md:h-9 align-self-center"/>Address :<small className="subtext"></small></p></div>
