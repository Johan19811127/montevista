...
<p className="text-md lg:text-md font-semibold text-start ">Store:</p<a href="mailto:finance@montevistaps.co.za" className="ml-7 text-md lg:text-md text-gray-700 font-normal text-start"> Clothingstore@montevistaps.co.za</a></p></div>
</div>
<div className="lg:container mx-auto lg:w-[80%] flex flex-col lg:flex-row p-3">
