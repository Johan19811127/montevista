...
<div className="basis-2/5 lg:basis-2/6 items-center text-start lg:px-5 "><p className=" text-xl mb-3 md:mb-1 lg:text-md font-bold text-gray-800 "><BusinessOutlinedIcon className="mr-3  md:w-12 md:h-12 align-self-center"/>  Address:</p></div>
...
<div className="basis-2/5 lg:basis-2/6 items-center text-start lg:px-5 "><p className=" text-lg mb-3 md:mb-1 lg:text-md font-bold text-gray-800 "><WatchLaterOutlinedIcon className="mr-3  md:w-12 md:h-12 align-self-center"/>  Shop Hours:</p></div>
