...
export default function Beproud() {
  ...
  <Image src="/Proud.png" width="400" height="160" className=" self-center max-w-[60%] mx-auto mb-4" alt="Bwe Proud , Wees trots the new motto of Monte Vista primary school"></Image>
  </div>
