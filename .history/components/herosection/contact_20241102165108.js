...
export default function Contact() {
  ...
  return (
    <div className="w-full min-h-screen content-center items-center">
        ...
        <div className="lg:container mx-auto lg:w-[60%] flex flex-col  p-3">
<h1 className="text-4xl font-bold tracking-tight mb-3 text-center text-gray-800 md:text-6xl">Get in touch</h1>
<p className="text-sm text-gray-700 text-center leading-tight  font-md mt-5 mb-5 text-justify ">At Monte Vista Primary School, we value open communication and are always eager to hear from our community. Whether you have questions about our curriculum, want to learn more about our Early Development Center, or need assistance with any school-related matter, our dedicated staff is here to help. You can reach us by phone, email, or by visiting our school office during working hours. </p></div></div>
