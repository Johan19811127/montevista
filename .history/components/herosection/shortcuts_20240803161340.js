...
export default function Shortcuts() {
  return (
    <div className="p-3 flex flex-col container mb-3 mx-auto h-screen py-4 px-3 lg:w-[80%] lg:px-8 h-auto min-h-screen flex justify-center align-center ">
        ...
        <p className=" text-sm lg:text-lg text-dblue text-center leading-tight   text-justify"> Our site is designed with user convenience in mind, offering quick and easy access to popular information you might need. Use the navigation links to explore various sections, including Academics,Extracurricular Activities, Our Fees or Admissions. </p>
