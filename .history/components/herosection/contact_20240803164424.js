...
<div className="md:basis-1/4"><p className="contacttextsml text-dblue  font-bold text-md lg:text-lg text-start" style={{lineHeight:'1.2'}}><MailOutlineOutlinedIcon className=" mr-3 md:w-10 md:h-10 align-self-center"/>Email :</p></div>
<div className="md:basis-3/4"><p className="contacttextsml text-dblue text-default lg:text-md text-start" style={{lineHeight:'1.2'}}> <a href="mailto:montevistaprimaryschool@gmail.com">Main : Montevistaprimaryschool@gmail.com</a><br></br><a href="mailto:fees.montevista@gmail.com">Fees: Fees.montevista@gmail.com</a><br></br><a href="mailto:finance@montevistaps.co.za">Finance: Finance@montevistaps.co.za</a></p></div>
</div>
<div className="flex flex-col md:flex-row mx-auto my-auto  p-3">
