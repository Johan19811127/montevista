...
export default function Shortcuts() {
  return (
    <div className="p-3 flex flex-row h-screen w-100">
    <div class="grid grid-cols-2 md:grid-col-3  lg:grid-cols-4 justify-items-center align-content-center gap-4 min- md:container m-4 p-5">
