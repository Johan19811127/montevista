...
export default function Intro() {
  return (
  <div className="container mb-3 mx-auto h-screen py-4 pxlg:w-[80%] lg:px-8 h-auto min-h-screen flex justify-center align-center ">
