...
export default function Contact() {
  ...
  return (
    <div className="mx-auto my-auto container lg:w-[80%] lg:px-8 h-screen">
        <div className="flex flex-col my-auto"></div>
        <h1 className="text-3xl font-bold tracking-tight mt:auto mb-5 text-center text-slate-800 sm:text-6xl">Get in touch</h1>
...
<div className="container">
            ...
            <h2 className="text-3xl font-bold tracking-tight text-center text-slate-800 sm:text-4xl">Contact Us</h2>
