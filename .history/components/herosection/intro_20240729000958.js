...
export default function Intro() {
  ...
  <img src="/60Badge.png" className="badge60 w-50 self-center mx-400 " alt="In 2023 Monte Vista Primary School celebrated its 60th anniversary"></img>
  </div>
     <div className="text-center">
       <h1 className="text-7xl font-bold tracking-tight text-slate-700 sm:text-7xl">
         Monte Vista 
       </h1>
       <h3 className="text-5xl font-bold tracking-tight text-slate-700 sm:text-5xl">
      MONTE  Primary School
       </h3>
