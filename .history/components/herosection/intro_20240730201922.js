...
export default function Intro() {
  ...
  <Image src="/60Badge.png" width="300" height="140" className=" self-center mx-auto mb-4" alt="In 2023 Monte Vista Primary School celebrated its 60th anniversary"></g>
  </div>
