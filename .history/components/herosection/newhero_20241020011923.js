...
export default function NewHero() {
 ...
 <>
        ...
        {/* Section 1 */}
        <div className="container my-auto mx-auto h-auto min-h-screen py-6 px-2  lg:px-8 h-auto min-h-screen flex flex-col-reverse  md:flex-row justify-center align-center content-center items-center ">
        <div className="w-full md:basis-1/2 align-items-center h-full flex flex-row justify-items-center">
        <div className="container m-auto">
          <h1 className="lg:text-6xl text-5xl leading-tight text-slate-800 font-bold mb-0 font-bold text-center">Monte Vista Primary School</h1>
          <h2 className="text-4xl font-bold text-slate-700 text-center mt-0"></h2>
        ...
        <div className=" w-full md:basis-1/2 flex justify-center">
          <Image
            ...
            width={500}
            height={500}
            className="drop-shadow-lg w-[100%] max-w-[80vw] text-center"
          />
        </div>
      </div>
      <section >
