...
<div className="md:basis-1/3"><p className="contacttextsml text-dblue  font-bold text-md lg:text-md text-start" style={{lineHeight:'1.2'}}><MailOutlineOutlinedIcon className=" mr-2 md:w-9 md:h-9 align-self-center"/>Email :</p></div>
