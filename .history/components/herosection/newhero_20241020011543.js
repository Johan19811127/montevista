...
export default function NewHero() {
 ...
 <>
        ...
        <div className="container m-auto">
          <h1 className="lg:text-6xl text-5xl leading-tight text-slate-800 font-bold mb-0 font-bold text-center">Monte Vista</h1>
          <h2 className="text-4xl font-bold text-slate-700 text-center mt-0">Primary School</h2>
