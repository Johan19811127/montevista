...
function NewHero() {
 ...
 <>
        ...
        <Image  src={isMobile ? '/cellhero.png' : '/Hero.png'} layout="responsive" width="1000" height="600" alt="Monte Vista Primary School" className=" w-full lg:w-[75%] mx-auto py-5"></Image>
