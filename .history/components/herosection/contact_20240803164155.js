...
<div className="md:basis-1/6"><PhoneAndroidOutlinedIcon className=" w-8 md:w-10 h-8 md:h-10 align-self-center" /></div>
<div className="md:basis-2/6"><p className=" text-default lg:text-md font-bold text-dblue text-start ">Telephone :</p></div>
<div className="md:basis-3/6"><p className="text-default lg:text-md  text-dblue text-start"> <a href="tel:0215584637">(021) 558 4637</a></p></div>
</div>

<div className="flex flex-col md:flex-row mx-auto my-auto  p-3">
<div className="md:basis-1/6"><MailOutlineOutlinedIcon className="md:w-10 md:h-10 align-self-center"/></div>
<div className="md:basis-2/6"><p className="contacttextsml text-dblue  font-bold text-md lg:text-lg text-start" style={{lineHeight:'1.2'}}>Email :</p></div>
<div className="md:basis-3/6"><p className="contacttextsml text-dblue text-default lg:text-md text-start" style={{lineHeight:'1.2'}}> <a href="mailto:montevistaprimaryschool@gmail.com">Main : Montevistaprimaryschool@gmail.com</a><br></br><a href="mailto:fees.montevista@gmail.com">Fees: Fees.montevista@gmail.com</a><br></br><a href="mailto:finance@montevistaps.co.za">Finance: Finance@montevistaps.co.za</a></p></div>
</div>
<div className="flex flex-col md:flex-row mx-auto my-auto  p-3">
<div className="md:basis-1/6"><BusinessOutlinedIcon className="md:w-10 md:h-10 align-self-center"/></div>
<div className="md:basis-2/6"><p className="contacttextsml text-dblue font-bold text-default  lg:text-lg text-start" style={{lineHeight:'1.2'}}>Address :<small className="subtext"></small></p></div>
<div className="md:basis-3/6"><p className="contacttextsml text-dblue text-default lg:text-lg text-start" style={{lineHeight:'1.2'}}> <a href="">7 Huising Avenue<br/>Monte Vista<br/>7460</a></p></div>

</div>
<div className="flex flex-col md:flex-row mx-auto my-auto  p-3">
<div className="md:basis-1/6"><WatchLaterOutlinedIcon className="w-10 h-10 align-self-center"/></div>
<div className="md:basis-2/6"><p className="contacttextsml text-dblue text-default font-bold lg:text-lg text-start" style={{lineHeight:'1.2'}}>Trading Hours :<br/><small className="subtext" style={{marginLeft:'0px'}}>(Clothing Store)</small></p></div>
<div className="md:basis-3/6"><p className="contacttextsml text-dblue text-default lg:text-lg text-start"  style={{lineHeight:'1.2'}}> Tuesdays 07:30am - 08:15am <br/>Wednesday 13:00pm - 14:30pm</p></div>
