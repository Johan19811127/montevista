...
export default function Beproud() {
  return (
  <div className="container my-auto mx-auto h-auto min-h-screen py-4 px-2 lg:w-[80%] lg:px-8 h-auto min-h-screen flex flex-col flex-row justify-center align-center ">
