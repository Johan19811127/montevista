...
<p className="text-md lg:text-md font-semibold text-start ">Finance:</p><a href="mailto:finance@montevistaps.co.za" className="ml-3 text-md lg:text-md text-gray-700 font-normal text-start"> Finance@montevistaps.co.za</a></p>
