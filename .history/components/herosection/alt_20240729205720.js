    ...
    <div className="relative flex flex-col justify-between h-dvh h size-full md:flex-row h-screen">
      <div className="flex my-auto md:w-1/2 pl-8 max-w-screen-md bg-white bg-opacity-75 ">
        <div className="text-center">
          <img src="/School badge - own.png" className="w-1/4 mx-auto mb-6"></img>
          <h1 className="text-7xl font-bold mb-1 text-slate-900">Monte Vista </h1>
          <h2 className="text-7xl font-bold mb-1 text-slate-900">Primary School </h2>
          <h2 className="text-3xl font-bold text-yellow-500 mb-6">Be Proud / Wees Trots</h2>
          <p className="text-base mb-4 mx-auto leading-tight">   Situated in the heart of Monte Vista, a bustling suburb in the Northern Suburbs of Cape Town, Monte Vista Primary School has stood as an educational cornerstone since its establishment in 1963. Serving students from Grade R to Grade 7, 
