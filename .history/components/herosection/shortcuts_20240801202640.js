...
export default function Shortcuts() {
  return (
    <div className="p-3 flex flex-col md:flex-row md:min-h-screen w-100 ">
      ...
      <div className="container mt-10 mx-auto w-2/3">
        ...
        <div className="px-1 md:basis-2/3 md:px-3 py-3">
    <div class="grid grid-cols-2 md:grid-cols-3  lg:grid-cols-4 justify-items-center align-content-center gap-4  md:container md:m-4 md:p-5">
