...
<div className="md:basis-1/4"><p className=" text-default lg:text-md font-bold text-dblue text-start "><PhoneAndroidOutlinedIcon className="mr-3  w-8 md:w-10 h-8 md:h-10 align-self-center" />Telephone :</p></div>
<div className="md:basis-3/4"><p className="text-default lg:text-md  text-dblue text-start"> <a href="tel:0215584637">(021) 558 4637</a></p></div>
</div>
