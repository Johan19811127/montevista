...
<div className="md:basis-2/6"><p className="contacttextsml text-dblue font-bold text-default  lg:text-lg text-start" style={{lineHeight:'1.2'}}><BusinessOutlinedIcon className="md:w-10 md:h-10 align-self-center"/>Address :<small className="subtext"></small></p></div>
