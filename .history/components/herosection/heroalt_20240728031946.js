...
export default function Heroalt() {
  return (
  <div className="flex flex-row bg-blue-950 h-90 justify-stretch items-stretch md:flex-column-reverse flex-container">
  
  <div className="basis-1/2  self-end md:width:100vw flex-item"><img src="/heroboy.png" className="w-100 "></img></div>
  ...
  <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
     ...
     <div className="text-center">
       ...
       <div className="mt-10 flex items-center justify-center gap-x-6">
         <a
           href="#"
           className="rounded-md bg-yellow-500 px-5 py-2.5 text-lg font-semibold text-slate-950 shadow-sm hover:bg-yellow-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
         >
           Get started
         </a>
