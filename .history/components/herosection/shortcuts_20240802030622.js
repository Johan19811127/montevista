...
<div className="card flex flex-col p-4 rounded-xl shadow-xl border-2 border-slate-200 self-normal">
    ...
    <Image src="/Axademic.png" width="140" height="140" className="mx-auto mb-4 " alt="Academic Services"></Image>
...
<div className="card flex flex-col p-4 rounded-xl shadow-xl  border-2 border-slate-200 self-normal">
    ...
    <Image src="/sports.png"width="140" height="140" className="mx-auto mb-4 " alt="Extra Curricular"></Image>
...
<div className="card flex flex-col p-4 rounded-xl shadow-xl  border-2 border-slate-200 self-normal">
    ...
    <Image src="/uniform.png" width="140" height="140" className="mx-auto mb-4 opacity-75" alt="Meet the team"></Image>
...
<div className="card flex flex-col p-4 rounded-xl shadow-xl  border-2 border-slate-200 self-normal">
    ...
    <Image src="/policies.png" width="140" height="140" className="mx-auto mb-4 " alt="policies"></Image>
...
<div className="card flex flex-col p-4 rounded-xl shadow-xl  border-2 border-slate-200 self-normal">
    ...
    <Image src="/contact.png"width="140" height="140" className="mx-auto mb-4 " alt="Contact us"></Image>
...
<div className="card flex flex-col p-4 rounded-xl shadow-xl  border-2 border-slate-200 self-normal">
    ...
    <Image src="/store.png" width="140" height="140" className="mx-auto mb-4 " alt="Onlinee Store"></Image>
