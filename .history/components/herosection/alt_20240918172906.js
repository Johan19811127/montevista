...
const HeroSection = () => {
  ...
  return (
    <div className="relative flex flex-col justify-start md:justify-between h-screen md:max-w-[1500px]">
      <div className="flex content-center items-center md:my-auto mx-auto md:w-1/2 md:ml-8">
        <div className="text-center mx-auto">
        
          <h1 className="text-3xl font-bold text-dblue leading-none md:text-5xl">Monte Vista Primary School</h1>
        <Image src="/Hero.png" width="1600" height="800" alt="Welcome to Monte Vista Primary School"></Image>
