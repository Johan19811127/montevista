...
export default function NewHero() {
 ...
 <>
        ...
        <Image  src={isMobile ? '/cellhero.png' : '/Hero.png'}  width="1000" height="600" alt="Monte Vista Primary School" className=" w-full max-w-[1200px] mx-auto py-2"></Image>
