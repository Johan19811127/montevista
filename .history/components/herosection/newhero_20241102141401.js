...
export default function NewHero() {
 ...
 <>
        ...
        <div className="container my-auto mx-auto min-h-screen py-8 px-2  mt-8 lg:mt-2 lg:px-8 h-auto flex flex-col justify-center align-center content-center items-center ">
        <h1 className="text-3xl leading-tight text-slate-800 font-bold my-4 mt-12 font-bold text-center">Monte Vista Primary School</h1>
        ...
        <div className="container mx-auto lg:w-[60%] px-2">
          ...
          <Image  src={isMobile ? '/cellhero.png' : '/Hero.png'}  width="1000" height="600" alt="Monte Vista Primary School" className=" w-full max-w-[1200px] mx-auto py-2 -mt-5"></Image>
      </div>
      <section >
      {/* Section 2: About */}
