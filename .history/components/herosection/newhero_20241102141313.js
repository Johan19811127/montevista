...
export default function NewHero() {
 ...
 <>
        ...
        <div className="container my-auto mx-auto h-screen py-8 px-2  mt-8 lg:mt-2 lg:px-8 h-auto flex flex-col justify-center align-center content-center items-center ">
