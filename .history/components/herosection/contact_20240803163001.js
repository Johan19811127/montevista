...
<div className="flex md:flex-row mx-auto my-auto  p-3">
<div className="md:basis-1/6"><MailOutlineOutlinedIcon className="w-10 h-10 align-self-center"/></div>
<div className="md:basis-2/6"><p className="contacttextsml text-dblue  font-bold text-default lg:text-lg text-start" style={{lineHeight:'1.2'}}>Email :<small className="subtext">(main)</small><br></br>Email :<small className="subtext">(School Fees)</small><br></br>Email :<small className="subtext">(Accounts)</small></p></div>
<div className="md:basis-3/6"><p className="contacttextsml text-dblue text-default lg:text-lg text-start" style={{lineHeight:'1.2'}}> <a href="mailto:montevistaprimaryschool@gmail.com">Montevistaprimaryschool@gmail.com</a><br></br><a href="mailto:fees.montevista@gmail.com">Fees.montevista@gmail.com</a><br></br><a href="mailto:finance@montevistaps.co.za">Finance@montevistaps.co.za</a></p></div>
</div>
<div className="flex flex-col md:flex-row mx-auto my-auto  p-3">
<div className="md:basis-1/6"><BusinessOutlinedIcon className="w-10 h-10 align-self-center"/></div>
