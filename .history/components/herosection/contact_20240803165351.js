...
<div className="md:basis-3/8"><p className="contacttextsml text-dblue font-bold text-default  lg:text-md text-start" style={{lineHeight:'1.2'}}><BusinessOutlinedIcon className="mr-2 md:w-9 md:h-9 align-self-center"/>Address :<small className="subtext"></small></p></div>
<div className="md:basis-5/8"><p className="contacttextsml text-dblue text-default lg:text-md text-start" style={{lineHeight:'1.2'}}> <a href="">7 Huising Avenue<br/>Monte Vista<br/>7460</a></p></div>
