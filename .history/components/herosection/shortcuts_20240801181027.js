...
export default function Shortcuts() {
  return (
    <div className="p-3 flex flex-row min-h-screen w-100 ">
        <div className="md:basis-1/3 md:flex md:w-full flex-col md:min-h-screen">
      <div className="container mt-10 mx-auto w-4/5">
        <h1 className="text-2xl font-bold tracking-tight text-slate-800 lg:text-6xl my-auto">Quick Links</h1>
