...
const HeroSection = () => {
  ...
  return (
    <div className="relative flex flex-col md:flex-row h-screen">
      ...
      <div className="masonry-container md:w-100 h-full overflow-hidden relative">
        ...
        {images.map((src, index) => (
            <div key={index} className="masonry-item h-96 w-66 overflow-hidden rounded-lg bg-gray-300 h-64 rounded-lg shadow-md">
