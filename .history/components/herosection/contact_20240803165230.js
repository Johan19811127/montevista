...
<div className="md:basis-1/4"><p className="contacttextsml text-dblue  font-bold text-md lg:text-md text-start" style={{lineHeight:'1.2'}}><MailOutlineOutlinedIcon className=" mr-2 md:w-10 md:h-10 align-self-center"/>Email :</p></div>
...
<div className="md:basis-1/4"><p className="contacttextsml text-dblue text-default font-bold lg:text-lg text-start" style={{lineHeight:'1.2'}}><WatchLaterOutlinedIcon className="mr-2 md:w-9 md:h-9 align-self-center"/>Trading Hours :<br/><small className="subtext" style={{marginLeft:'0px'}}>(Clothing Store)</small></p></div>
<div className="md:basis-3/4"><p className="contacttextsml text-dblue text-default lg:text-lg text-start"  style={{lineHeight:'1.2'}}> Tuesdays 07:30am - 08:15am <br/>Wednesday 13:00pm - 14:30pm</p></div>
