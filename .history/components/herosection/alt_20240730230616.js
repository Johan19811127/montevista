...
const HeroSection = () => {
  ...
  return (
    <div className="relative flex flex-col justify-between h-screen md:flex-row backhero">
      <div className="flex my-auto mx-auto md:w-1/2 pl-8 max-w-scr bg-white bg-opacity-25een-md ">
        <div className="text-center mx-auto">
          ...
          <div className="container bg-white bg-opacity-35">
          <p className="text-lg mb-4 mx-5 text-dblue font-medium leading-tight mt-8">
