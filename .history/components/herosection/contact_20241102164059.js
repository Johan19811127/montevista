...
<div className="lg:basis-5/6 text-start"></div>
<a href="mailto:finance@montevistaps.co.za" className="text-md lg:text-md text-gray-700 font-normal text-start"> Clothingstore@montevistaps.co.za</a></p></div>
</div>
<div className="lg:container mx-auto lg:w-[80%] flex flex-col lg:flex-row p-3">
