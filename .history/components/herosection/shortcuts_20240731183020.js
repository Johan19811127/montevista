...
<div className="card flex flex-col p-4 rounded-xl shadow-xl h-100 w-80">
    ...
    <Image src="/meet the team.png" width="150" height="150" className="mx-auto mb-4" alt="Meet the team"></Image>
    <h2 className="text-xl text-dblue mx-auto font-bold mb-4 text-center">Meet the Team</h2>
    <p className="text-default text-dblue text-center leading-tight text-md m-5">See who makes up the team at Monte Vista Primary School.</p>
</div>
