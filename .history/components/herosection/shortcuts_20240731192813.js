...
<div className="card flex flex-col p-4 rounded-xl shadow-xl  w-80 border-2 border-slate-200 self-normal">
    ...
    <p className="text-default text-dblue text-center leading-tight text-md m-5">Discover the exciting array of extracurricular activities at Monte Vista Primary School,</p>
</div>
