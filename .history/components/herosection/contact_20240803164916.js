...
<div className="md:basis-1/4"><p className=" text-default lg:text-md font-bold text-dblue text-start "><PhoneAndroidOutlinedIcon className="mr-3   align-self-center" />Telephone :</p></div>
