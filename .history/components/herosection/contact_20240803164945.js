...
<div className="md:basis-2/6"><p className="contacttextsml text-dblue text-default font-bold lg:text-lg text-start" style={{lineHeight:'1.2'}}><WatchLaterOutlinedIcon className="mr-2 w-10 h-10 align-self-center"/>Trading Hours :<br/><small className="subtext" style={{marginLeft:'0px'}}>(Clothing Store)</small></p></div>
