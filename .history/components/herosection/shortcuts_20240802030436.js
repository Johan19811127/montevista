...
<div className="card flex flex-col p-4 rounded-xl shadow-xl border-2 border-slate-200 bg-white-900 align-self-normal ">
    ...
    <Image src="/Admissions.png" width="140" height="140" className="mx-auto mb-4" alt="Admissions"></Image>
    <h2 className="text-xl text-dblue mx-auto font-bold mb-4 text-center">Admissions</h2>
    <p className="text-normal text-dblue text-center leading-tight text-md m-5">All the information parents would need if they wish to enroll their child at Monte Vista Primary School</p>
</div>
