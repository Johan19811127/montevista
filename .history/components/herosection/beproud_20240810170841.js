...
export default function Beproud() {
  ...
  <div className="container my-auto mx-auto h-auto min-h-screen py-6 px-2 lg:w-[80%] lg:px-8 h-auto min-h-screen flex flex-col  md:flex-row justify-center align-center ">
   ...
   <Image src="/throthy.png" width="500" height="500" alt="Be Proud / Wees Trots" className=" self-center max-w-[90vw] mx-auto mb-4"></Image>
...
<h2 className="text-4xl font-bold  text-center text-dblue">Be Proud / Wees Trots</h2>  
