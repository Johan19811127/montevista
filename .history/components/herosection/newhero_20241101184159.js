...
export default function NewHero() {
 ...
 <>
        ...
        <div className="container my-auto mx-auto h-auto py-6 px-2  lg:px-8 h-auto min-h-screen flex flex-row  md:flex-row justify-center align-center content-center items-center ">
