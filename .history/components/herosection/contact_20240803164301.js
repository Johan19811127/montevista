...
<div className="md:basis-2/6"><p className="contacttextsml text-dblue  font-bold text-md lg:text-lg text-start" style={{lineHeight:'1.2'}}><MailOutlineOutlinedIcon className="d:w-10 md:h-10 align-self-center"/>Email :</p></div>
