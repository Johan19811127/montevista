...
<div className="md:basis-1/3"><p className=" text-default lg:text-md font-bold text-dblue text-start "><PhoneAndroidOutlinedIcon className="mr-3  w-8 md:w-9 h-8 md:h-9 align-self-center" />Telephone :</p></div>
...
<div className="md:basis-3/8"><p className="contacttextsml text-dblue text-default font-bold lg:text-md text-start" style={{lineHeight:'1.2'}}><WatchLaterOutlinedIcon className="mr-2 md:w-9 md:h-9 align-self-center"/>Trading Hours :<br/><small className="subtext" style={{marginLeft:'0px'}}>(Clothing Store)</small></p></div>
<div className="md:basis-5/8"><p className="contacttextsml text-dblue text-default lg:text-md text-start"  style={{lineHeight:'1.2'}}> Tuesdays 07:30am - 08:15am <br/>Wednesday 13:00pm - 14:30pm</p></div>
