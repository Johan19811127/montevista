...
<div className="basis-3/5 lg:basis-4/6  items-center "><p className="text-xl mb-3 md:mb-1 lg:text-md font-bold text-start"></p> <a href="tel:0215584637" className="text-md lg:text-md font-semibold text-start">(021) 558 4637</a></div>
</div>
