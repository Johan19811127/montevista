...
<div className="lg:basis-5/6 text">
<a href="mailto:montevistaprimaryschool@gmail.com" className="ml-8 text-md lg:text-md text-gray-700 font-normal text-start"> Montevistaprimaryschool@gmail.com</a></p></div>
