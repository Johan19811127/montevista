...
<div className="basis-2/6"><p className="contacttextsml text-dblue  font-bold text-default lg:text-lg text-start" style={{lineHeight:'1.2'}}>Email :<small className="subtext">(main)</small><br></br>Email :<small className="subtext">(School Fees)</small><br></br>Email :<small className="subtext">(Accounts)</small></p></div>
