...
export default function Shortcuts() {
  return (
    <div class="grid grid-cols-2 md:grid-col-3  lg:grid-cols-4 justify-items-center align-content-center gap-4 min-h-screen md:container m-auto ">
<div className="card flex flex-col p-4 rounded-xl shadow-xl h-auto w-80 border-2 border-slate-200">
...
<div className="card flex flex-col p-4 rounded-xl shadow-xl h-100 w-80 border-2 border-slate-200">
