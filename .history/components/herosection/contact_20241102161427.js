...
<a href="mailto:montevistaprimaryschool@gmail.com" className="lg:ml-8 text-md lg:text-md text-gray-700 font-normal text-start"> Montevistaprimaryschool@gmail.com</a></div></div>
