...
export default function Shortcuts() {
  return (
    <div className="p-3 flex flex-row min-h-screen w-100 ">
        <div className="basis-1/3 flex h-auto">
      
        <h1 className="text-2xl font-bold tracking-tight text-slate-800 sm:text-4xl">Quick Links</h1>
    
        <p>Quickly Navigate our website by clicking on one of these cards to quickly find exactly what you are looking for. For a full list o0f all content please see the menu at the top of eachj page</p>
