    ...
    <Image src="/Badge.png" width="200" height="250" alt="Monte Vista Primary badge" className="mx-auto w-[20%]"></Image>
     ...
     Welcome to
      ...
      Monte Vista Primary School
       ...
       <Image src="/intro.png" width="400" height="800" alt="Monte Vista primary has been around since 1963" hidden className=" md:block relative float-right  intro  w-[200px] max-w-[55%] md:max-w-[220px] lg:max-w-[300px] w-full bottom-0  ms-auto"></Image>
     <p className=" mt-3 lg:mt-6 text-default lg:text-md leading-tight text-gray-700   text-justify">As parents embark on the exciting journey of choosing the right educational environment for their children, Monte Vista Primary School stands out as a beacon of excellence with a commitment to providing a nurturing and innovative learning experience. At the heart of this exceptional institution is the deliberate decision to keep classrooms smaller, ensuring individualized attention for each child. With an average class size ranging from 25 to 30 learners, Monte Vista Primary School creates an environment where every student can thrive.</p>
    
     <p className="mt-3 lg:mt-6 text-default lg:text-md leading-tight text-gray-700   text-justify">The integration of technology plays a pivotal role in shaping the modern learning landscape at Monte Vista. In every classroom, Clevertouch interactive touchscreen displays take center stage, offering more than just an interactive whiteboard. These state-of-the-art displays feature educational apps that empower teachers to enhance lessons, play engaging videos and music, and involve learners in a dynamic and interactive educational experience like never before.   
</p>
