...
<div className=" lg:basis-2/6 items-center text-start lg:px-5 "><p className=" text-xl mb-3 md:mb-1 lg:text-md font-bold text-gray-800 "><MailOutlineOutlinedIcon className=" mr-3  md:w-12 md:h-12 align-self-center"/>  Email:</p></div>
