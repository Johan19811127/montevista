...
<p className="text-md lg:text-md font-semibold text-start "> Main :</p></div><a href="mailto:montevistaprimaryschool@gmail.com" className="ml-8 text-md lg:text-md text-gray-700 font-normal text-start"> Montevistaprimaryschool@gmail.com</a></p></div>
