...
export default function Intro() {
  return (
    ...
    <Image src="/Badge.png" width="200" height="250" alt="Monte Vista Primary badge" className="mx-auto w-[20%]"></Image>
     ...
     <Image src="/intro.png" width="400" height="800" alt="Monte Vista primary has been around since 1963" hidden className=" md:block relative float-right  intro  w-[200px] max-w-[55%] md:max-w-[220px] lg:max-w-[350px] w-full bottom-0  ms-auto"></Image>
