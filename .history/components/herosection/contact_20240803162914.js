...
<div className="md:basis-2/6"><p className="contacttextsml text-dblue text-de  lg:text-lg text-start" style={{lineHeight:'1.2'}}>Address :<small className="subtext"></small></p></div>
