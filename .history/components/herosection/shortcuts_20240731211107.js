...
<div className="card flex flex-col p-4 rounded-xl shadow-xl  border-2 border-slate-200 self-normal">
    ...
    <Image src="/mcontact.png" width="200" height="200" className="mx-auto mb-4 " alt="Contact us"></Image>
    <h2 className="text-xl text-dblue mx-auto font-bold mb-4 text-center">Contact Us</h2>
    <p className="text-default text-dblue text-center leading-tight text-md m-5">Reach out to Monte Vista Primary School, we would love to hear from you.</p>
</div>
