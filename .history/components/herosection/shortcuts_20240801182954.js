...
export default function Shortcuts() {
  return (
    <div className="p-3 flex flex-row min-h-screen w-100 ">
        <div className="md:basis-1/3 md:flex md:w-full flex-col md:min-full md:pt-10">
      <div className="container mt-10 mx-auto w-2/3">
        <h1 className="text-2xl font-bold tracking-tight text-dblue lg:text-6xl mb-10 text-center">Quick Links</h1>
    
        <p className="text-lg text-dblue text-center leading-tight  font-bold text-justify"> Our site is designed with user convenience in mind, offering quick and easy access to popular information you might need. Use the navigation links to explore various sections, including Academics, Admissions,Our Fees or Extracurricular Activities. </p>
        <p className="text-lg text-dblue text-center leading-tight  font-bold mt-5 text-justify "> Whether you are looking for detailed information on our curriculum, interested in enrolling your child, or seeking the latest school news and events, these links will guide you directly to your destination. Navigate effortlessly and discover what makes Monte Vista Primary School a nurturing and dynamic environment for young learners.</p>
        </div>
        
        <div className="mt-10 mb-10">
            <Image src="/Mouse click.png" width="700" height="700" alt="hand Click"></Image>
        </div>
        
        
        </div>
        <div className="basis-2/3 px-3 py-3">
    <div class="grid grid-cols-2 md:grid-col-3  lg:grid-cols-4 justify-items-center align-content-center gap-4  md:container m-4 p-5">
...
<div className="card flex flex-col p-4 rounded-xl shadow-xl  border-2 border-slate-200 self-normal">
    ...
    <Image src="/store.png" width="200" height="200" className="mx-auto mb-4 " alt="Onlinee Store"></Image>
    <h2 className="text-xl text-dblue mx-auto font-bold mb-4 text-center">Online Store</h2>
    <p className="text-default text-dblue text-center leading-tight text-md m-5">Reach out to Monte Vista Primary School, we we are always ready to assist with your inquiries..</p>
</div>
</div>
</div>
