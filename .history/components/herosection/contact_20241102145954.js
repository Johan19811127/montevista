...
<div className="basis-4/5 lg:basis-4/6 text-start"><p className="text-lg lg:text-xl font-bold text-gra y-800 text-start"></p> <a href="tel:0215584637" className="text-md lg:text-md font-semibold text-start">(021) 558 4637</a></div>
</div>
