...
<div className="flex flex-col lg:flex-row">
  <div className="lg:basis-/6 "
<p className="text-md lg:text-md font-semibold text-start "> Main :<a href="mailto:montevistaprimaryschool@gmail.com" className="ml-8 text-md lg:text-md text-gray-700 font-normal text-start"> Montevistaprimaryschool@gmail.com</a></p></div>
