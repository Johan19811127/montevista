...
<div className="basis-2/5 lg:basis-2/6 items-center content-center"><p className=" text-xl mb-3 md:mb-1 lg:text-md font-bold text-gray-800 "><MailOutlineOutlinedIcon className=" mr-2 md:w-9 md:h-9 align-self-center"/></p></div>
<div className="basis-3/5 lg:basis-4/6 text-start"><p className="text-lg lg:text-xl font-bold text-gray-800 text-start">Email:</p><p className="text-md lg:text-md font-semibold text-start "> Main :<a href="mailto:montevistaprimaryschool@gmail.com" className="ml-8 text-md lg:text-md text-gray-700 font-normal text-start"> Montevistaprimaryschool@gmail.com</a></p>
