...
export default function Intro() {
  return (
    <>
    <div className="flex flex-col md:flex-row  min-h-[100vh] m-auto">
    ...
    <Image src="/Badge.png" width="200" height="250" alt="Monte Vista Primary badge" className="mx-auto w-[20%]"></Image>
     <h3 className="text-2xl font-bold tracking-tight text-slate-800 md:text-2xl lg:text-4xl">
     Welcome to
       </h3>
       <h3 className="text-3xl font-bold leading-tight text-slate-700 md:text-3xl lg:text-5xl ">
