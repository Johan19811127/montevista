...
<div className="basis-3/6"><p className="contacttextsml text-dblue text-defaulkt text-lg text-start" style={{lineHeight:'1.2'}}> <a href="">7 Huising Avenue<br/>Monte Vista<br/>7460</a></p></div>
