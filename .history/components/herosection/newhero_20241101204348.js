...
export default function NewHero() {
 ...
 <>
        ...
        <Image  src={isMobile ? '/cellhero.png' : '/Hero.png'} layout="responsive" width="1000" height="600" alt="Monte Vista Primary School" className=" w-full max-w-[1200px] mx-auto py-5"></Image>
      
     
    
     
        <div className="container mx-auto lg:w-[60%] lg:px-12 px-2">
