...
export default function Intro() {
  ...
  <Image src="/60Badge.png" width="400" height="160" className=" self-center max-w- mx-auto mb-4" alt="In 2023 Monte Vista Primary School celebrated its 60th anniversary"></Image>
  </div>
