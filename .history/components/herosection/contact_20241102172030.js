...
<div className="flex flex-col lg:flex-row">
<div className="lg:basis-1/6 ">
<p className=" text-lg mb-3 md:mb-1 lg:text-md font-bold text-gray-800 ">Tuesdays</p> </div>
<div className="lg:basis-5/6 text-start">
...
<p className=" text-lg mb-3 md:mb-1 lg:text-md font-bold text-gray-800 ">Wednesday </p>    </div> 
<div className="lg:basis-5/6 text-start">

<p>13:00pm - 14:30pm</p></div></div>
