    ...
    <div className="relative flex flex-col justify-between h-screen md:flex-row">
      <div className="flex my-auto md:w-1/2 pl-8 max-w-screen-md bg-white bg-opacity-75">
        <div className="text-center">
          <Image src="/School badge - own.png" width="250" height="500" className="w-1/3 mx-auto mb-6" alt="School Badge" />
          ...
          <p className="text-lg mb-4 mx-5 text-dblue font-bold leading-tight mt-5">
      ...
      <div className="md:w-1/2 bg-white bg-opacity-75 p-5 py-0 ">
