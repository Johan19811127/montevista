...
<div className="md:basis-1/3"><p className=" text-xl mb-3 md: lg:text-md font-bold text-dblue text-start "><PhoneAndroidOutlinedIcon className="mr-3  md:w-9 md:h-9 align-self-center" />Telephone :</p></div>
