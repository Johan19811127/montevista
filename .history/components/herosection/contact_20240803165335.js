...
<div className="md:basis-5/4"><p className="contacttextsml text-dblue text-default lg:text-md text-start" style={{lineHeight:'1.2'}}> <a href="mailto:montevistaprimaryschool@gmail.com">Main : Montevistaprimaryschool@gmail.com</a><br></br><a href="mailto:fees.montevista@gmail.com">Fees: Fees.montevista@gmail.com</a><br></br><a href="mailto:finance@montevistaps.co.za">Finance: Finance@montevistaps.co.za</a></p></div>
</div>
<div className="flex flex-col md:flex-row mx-auto my-auto  p-3">
