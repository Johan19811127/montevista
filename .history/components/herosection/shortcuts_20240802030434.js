...
<div className="card flex flex-col p-4 rounded-xl shadow-xl border-2 border-slate-200 bg-white-900 align-self-normal ">
    ...
    <p className="text- text-dblue text-center leading-tight text-md m-5">All the information parents would need if they wish to enroll their child at Monte Vista Primary School</p>
</div>
