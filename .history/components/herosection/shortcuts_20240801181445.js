  ...
  return (
    <div className="p-3 flex flex-row min-h-screen w-100 ">
      ...
      <div className="container mt-10 mx-auto w-2/3">
        ...
        <p className="text-lg">Quickly Navigate our website by clicking on one of these cards to quickly find exactly what you are looking for. For a full list of all content please see the menu at the top of each page.</p>
        </div>
