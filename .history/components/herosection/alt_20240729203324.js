...
const HeroSection = () => {
  return (
    <div className="relative flex flex-col justify-between place-content-stretch size-full md:flex-row h-screen">
      <div className="flex items-center  justify-items-center  items-center justify-center md:w-1/2  max-w-screen-md bg-white bg-opacity-75 ">
        <div className="text-center">
          <img src="/School badge - own.png" className="w-1/4 mx-auto"></img>
          <h1 className="text-4xl font-bold mb-1 text-blue-900">Monte Vista Primary School</h1>
          <h2 className="text-3xl font-bold text-yellow-600 mb-6">Be Proud / Wees Trots</h2>
          <p className="text-lg mb-4">   Situated in the heart of Monte Vista, a bustling suburb in the Northern Suburbs of Cape Town, Monte Vista Primary School has stood as an educational cornerstone since its establishment in 1963. Serving students from Grade R to Grade 7, 
