...
<div className="md:basis-1/3"><p className=" text-xl mb-3 md:mb lg:text-md font-bold text-dblue text-start "><PhoneAndroidOutlinedIcon className="mr-3  md:w-9 md:h-9 align-self-center" />Telephone :</p></div>
...
<div className="md:basis-1/3"><p className="contacttextsml text-dblue  font-bold text-xl lg:text-md text-start" style={{lineHeight:'1.2'}}><MailOutlineOutlinedIcon className=" mr-2 md:w-9 md:h-9 align-self-center"/>Email :</p></div>
...
<div className="md:basis-1/3"><p className="contacttextsml text-dblue font-bold text-xl  lg:text-md text-start" style={{lineHeight:'1.2'}}><BusinessOutlinedIcon className="mr-2 md:w-9 md:h-9 align-self-center"/>Address :<small className="subtext"></small></p></div>
...
<div className="md:basis-1/3"><p className="contacttextsml text-dblue text-xl font-bold lg:text-md text-start" style={{lineHeight:'1.2'}}><WatchLaterOutlinedIcon className="mr-2 md:w-9 md:h-9 align-self-center"/>Shop Hours:</p></div>
