...
const HeroSection = () => {
  return (
    <div className="relative flex flex-col justify-between place-content-stretch size-full md:flex-row h-screen">
      <div className="flex items-center  justify-items-center  items-center justify-center md:w-1/2 px-4 max-w-screen-md bg-white bg-opacity-75 ">
        <div className="text-center">
          <img src="/School badge - own.png" className="w-1/4 mx-auto"></img>
          <h1 className="text-4xl font-bold mb-1 text-blue-950">Monte Vista Primary School</h1>
