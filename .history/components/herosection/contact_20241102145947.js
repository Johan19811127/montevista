...
<div className="basis-2/5 lg:basis-1/6 items-center content-center"><p className=" text-xl mb-3 md:mb-1 lg:text-md font-bold text-gray-800 "><PhoneAndroidOutlinedIcon className="mr-3  md:w-12 md:h-12 align-self-center" /> Telephone:</p></div>
<div className="basis-4/5 lg:basis-5/6 text-start"><p className="text-lg lg:text-xl font-bold text-gra y-800 text-start"></p> <a href="tel:0215584637" className="text-md lg:text-md font-semibold text-start">(021) 558 4637</a></div>
</div>
