...
export default function HeroSection() {
  useEffect(() => {
    const handleScroll = () => {
      ...
      const schoolBlur = Math.max(30 - scrollPosition * 0.01, 15); // Starts at 10px blur, reduces with scroll
      const schoolOpacity = Math.min(0.1 + scrollPosition * 0.001, 0.50); // Starts at 30%, goes up to 60%
