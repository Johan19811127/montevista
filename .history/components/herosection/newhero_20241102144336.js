...
export default function NewHero() {
 ...
 <>
      ...
      <div className="w-full md:basis-2/3 align-items-center h-full flex px-3 flex-col justify-items-center  texsm:line-clamp-10 sm:overflow-hidden md:line-clamp-none md:overflow-visible">
