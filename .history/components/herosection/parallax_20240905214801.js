    ...
    return (
      <div className="relative h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 bg-fixed bg-center bg-no-repeat bg-cover"
          style={{ backgroundImage: "url('/images/school.jpg')", transform: 'translateZ(0)' }}
        ></div>
        
        {/* The parallax layer (child) */}
        <div className="absolute inset-0 flex items-center justify-center" 
          style={{ backgroundImage: "url('/images/child.jpg')", backgroundSize: 'contain', backgroundPosition: 'bottom', transform: 'translateZ(1)' }}>
