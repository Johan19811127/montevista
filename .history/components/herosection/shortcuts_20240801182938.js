  ...
  return (
    <div className="p-3 flex flex-row min-h-screen w-100 ">
      ...
      <div className="container mt-10 mx-auto w-2/3">
        ...
        <p className="text-lg text-dblue text-center leading-tight  font-bold "> Our site is designed with user convenience in mind, offering quick and easy access to popular information you might need. Use the navigation links to explore various sections, including Academics, Admissions,Our Fees or Extracurricular Activities. </p>
