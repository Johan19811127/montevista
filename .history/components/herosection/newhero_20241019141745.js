...
export default function NewHero() {
 ...
 <>
      ...
      <section >
      {/* Section 2: About */}
      <div className="container my-auto mx-auto h-auto min-h-screen py-6 px-2  gaplg:px-8 h-auto min-h-screen flex flex-col  md:flex-row justify-center align-center content-center items-center ">
