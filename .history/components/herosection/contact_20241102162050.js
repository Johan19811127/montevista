...
<p className="text-md lg:text-md font-semibold text-start ">Fees:</p></div> <a href="mailto:fees@montevistaps.co.za" className="ml-9 text-md lg:text-md text-gray-700 font-normal text-start">fees@montevistaps.co.za</a></p>
