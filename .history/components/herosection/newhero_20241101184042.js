...
export default function NewHero() {
 ...
 <>
        ...
        <Image src="/hero.png" width="1000" height="600" alt="Monte Vista Primary School" className="lg:w-full lg:d-block "></Image> <div className="w-full md:basis-1/4 align-items-center h-full flex flex-row justify-items-center"></div>
