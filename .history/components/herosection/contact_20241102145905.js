...
<div className="basis-1/5 lg:basis-1/6 items-center content-center"><p className=" text-xl mb-3 md:mb-1 lg:text-md font-bold text-gray-800 "><PhoneAndroidOutlinedIcon className="mr-3  md:w-12 md:h-12 align-self-center" /> Telephone:</p></div>
