...
export default function NewHero() {
 ...
 <>
        ...
        <div className="container my-auto mx-auto h-screen py-3 px-2  lg:px-8 h-auto flex flex-col justify-center align-center content-center items-center ">
      ...
      <Image
            ...
            width={500}
            height={600}
            className=" mx-auto w-[60% text-center max-w-[80vw]"
          />
      </div>
