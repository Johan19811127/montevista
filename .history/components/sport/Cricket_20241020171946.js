...
export default function Cricket() {
  return (
    <div className="max-w-8xl  bg-blue-50 shadow-sm   flex flex-col-reverse md:flex-row text-blue-500">
      ...
      <ul className="list-disc	gap-2 px-5 ">
       ...
       <div className="w-full md:basis-2/5 content-center items-center">
        <Image src="/crick.png" width="500" height="500" alt="Tennis offered by Monte Vista Primary School" className="w-full  drop-shadow-xl h-auto rounded-lg "></Image>
