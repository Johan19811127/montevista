      ...
      <ul className="list-disc	gap-2 px-5 ">
        ...
        <thead className="bg-yellow-200 text-blue-500 font-semibold">
          <tr>
            ...
            <th className="px-2 py-1 text-center border border-x-blue-500 md:w-[25%]"> Practice Days &amp; Times</th>
            <th className="px-2 py-1 text-center border border-x-blue-500 md:w-[20%]">Matches</th>
