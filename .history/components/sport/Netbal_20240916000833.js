  ...
  return (
    <div className="max-w-8xl rounded-xl bg-white shadow-sm  p-2 md:p-5 flex flex-col-reverse md:flex-row text-Violet-600 mb-5">
      ...
      <ul className="list-disc	gap-2 px-5 ">
        <li className="leading-tight text-sm text-Violet-600  text-justify ">The Cricket World Cup trophy contains a golden globe held by three silver columns, representing the three main aspects of cricket: batting, bowling, and fielding. </li>
        <li className="leading-tight text-sm text-Violet-600  text-justify ">In a single over, the highest number of runs scored in first-class cricket is 77. This unusual feat happened when a bowler bowled several no-balls and wides, and each ball went for runs!</li>
        </ul>
        </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td rowSpan="2" className="border border-Violet-400 px-2 py-1 text-center"><p className="font-semibold">Wed &amp;
            Thurs </p>13:45 – 14:45</td>
            <td rowSpan="2" className="border border-Violet-400 px-2 py-1 text-center"><p className="font-semibold">Thurs</p> 13:45-14:45</td>
            <td className="border border-Violet-400 px-2 py-1">D Botha &amp; N Kennedy</td>
          </tr>
          <tr>
          <td className="border border-Violet-400 px-2 py-1 px-1 leading-tight text-center">0/8</td>
          
          
            <td className="border border-Violet-400 px-2 py-1">C van Tonder &amp; S Palvie Swart</td>
          </tr>
          <tr>
          <td className="border border-Violet-400 px-2 py-1 leading-tight text-center">0/9</td>
          <td className="border border-Violet-400 px-2 py-1 text-center"><p className="font-semibold">Wed &amp;
           Thurs </p>13:45 – 14:45</td>
