...
export default function Cricket() {
  return (
    <div className="max-w-8xl  bg-blue-300 shadow-sm  mb-5  flex flex-col-reverse md:flex-row text-blue-500">
    
        <div className="basis-1/1 md:basis-3/5 p-4 md:p-5 ">
      ...
      <ul className="list-disc	gap-2 px-5 ">
        ...
        <thead className="bg-blue-500 text-white font-semibold">
          <tr>
            <th className="px-2 py-1 text-center  border border-e-white md:w-[15%]">Team</th>
            ...
            <th className="px-2 py-1 text-center  border border-s-white md:w-[40%]">Coaches</th>
          </tr>
        </thead>
       ...
       <div className="w-full md:basis-2/5 content-center items-center">
        <Image src="/crick.png" width="500" height="500" alt="Tennis offered by Monte Vista Primary School" className="w-full  drop-shadow h-auto rounded-lg "></Image>
