  ...
  return (
    <div className="max-w-8xl rounded-lg bg-white shadow-sm  p-2 md:p-5 flex flex-col md:flex-row text-indigo-600 mb-5">
      ...
      <ul className="list-disc	gap-2 px-5 ">
        ...
        <li className="leading-tight text-sm text-indigoi-700  text-justify ">Another significant change in the sport came in 1972, when tennis balls were switched from white to yellow to improve visibility for television audiences, marking a modern shift in how the game is viewed globally.</li>
        </ul>
        </div>
