...
export default function Athletics() {
  return (
    <div className="max-w-8xl rounded-lg bg-white shadow-sm  p-2 md:p-5 flex flex-col md:flex-row text-green-600 mb-5">
        <div className="w-full md:basis-2/5">
        <Image src="/tennis.png" width="500" height="500" alt="Tennis offered by Monte Vista Primary School" className="w-full h-auto rounded-ss-3xl rounded-es-2xl rounded-ee-[100px] rounded-se-xl "></Image>
        
        
        </div>
        <div className="basis-1/1 md:basis-3/5 p-2 md:p-5 items-center content-center">
      <h2   className="text-5xl font-bold pb-4 text-center">Athleticss</h2>
