...
export default function Athletics() {
  return (
    <div className="max-w-8xl rounded-lg bg-white shadow-sm  p-2 md:p-5 flex flex-col md:flex-row text-green-600 mb-5">
        ...
        <Image src="/ATHLE.png" width="500" height="500" alt="Tennis offered by Monte Vista Primary School" className="w-full h-auto rounded-ss-3xl rounded-es-2xl rounded-ee-[100px] rounded-se-xl "></Image>
