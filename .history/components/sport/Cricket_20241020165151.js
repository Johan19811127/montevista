    ...
    <div className="max-w-8xl  bg-blue-300 shadow-sm  p-2 md:p-5 flex flex-col-reverse md:flex-row text-blue-500">
      ...
      <ul className="list-disc	gap-2 px-5 ">
       ...
       <div className="w-full md:basis-2/5 content-center items-center">
        <Image src="/cricket
        .png" width="500" height="500" alt="Tennis offered by Monte Vista Primary School" className="w-full h-auto rounded-es-3xl rounded-se-2xl rounded-ss-[100px] rounded-ee-xl "></Image>
