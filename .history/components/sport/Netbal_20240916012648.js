      ...
      <ul className="list-disc	gap-2 px-5 ">
        ...
        <tbody>
          ...
          <td className="border border-violet-400 px-2 py-1 text-center"><p className="font-semibold">Mon &amp;
           Wed </p>14:15 – 15:15</td>
            <td className="border border-violet-400 px-2 py-1 text-center"><p className="font-semibold">Wed</p> 14:15-15:15</td>
          
        
            <td className="border border-violet-400 px-2 py-1">C. Vasconselos &amp; L.
            Pretorius</td>
          </tr>
          <tr>
            <td  className="border border-violet-400 px-4 py-1 px-2 text-center leading-tight">0/10</td>
            <td rowSpan="4" className="border border-violet-400 px-2 py-1 text-center"><p className="font-semibold">Mon &amp;
            Wed </p>14:45- 15:45</td>
            <td rowSpan="4" className="border border-violet-400 px-2 py-1 text-center"><p className="font-semibold">Wed</p> 14:45 – 15:45</td>
            <td className="border border-violet-400 px-2 py-1">F. Nel &amp; R. Hagen</td>
          </tr>
          <tr>
          <td className="border border-violet-400 px-2 py-1 px-1 leading-tight text-center">0/11</td>
       
            <td className="border border-violet-400 px-2 py-1">A. Kleyn &amp; , N. Kennedy</td>
          </tr>
          <tr>
            <td  className="border border-violet-400 px-4 py-1 px-2 text-center leading-tight">0/12B <br></br> 0/13B</td>
            <td className="border border-violet-400 px-2 py-1">G LomasL. van Rensburg &amp; M. du Toit</td>
          </tr>
          <tr>
          <td className="border border-violet-400 px-2 py-1 px-1 leading-tight text-center">>0/12B <br></br> 0/13B</td>
            <td className="border border-violet-400 px-2 py-1">J.Roelofse</td>
          </tr>
