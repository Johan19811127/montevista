      ...
      <ul className="list-disc	gap-2 px-5 ">
        ...
        <thead className="bg-blue-500 text-white font-semibold">
          <tr>
            ...
            <th className="px-2 py-1 text-center border border-white md:w-[25%]"> Practice Days &amp; Times</th>
            <th className="px-2 py-1 text-center border border-white md:w-[20%]">Matches</th>
