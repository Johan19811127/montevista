...
const Footer = () => {
    return (
      <footer className="bg-slate-300  py-12">
        <div className="container lex flex-col md:flex-row ">
          <div className="basis-1/1 md:basis-1/3">
           ...
           <div className="flex flex-row w-100"> 
            <div className="basis-1/2">    
              ...
              <h5 className="text-lg  mb-4">Column 1</h5>
              <ul className="leading-tight text-default">
                <li><a href="#" className="text-slate-800  ">Link 1</a></li>
                <li><a href="#" className="text-slate-800">Link 2</a></li>
                <li><a href="#" className="text-slate-800 ">Link 3</a></li>
                <li><a href="#" className="text-slate-800 ">Link 4</a></li>
              </ul>
            </div>
            ...
            <div className="basis-1/2">
              ...
              <ul className="leading-tight text-default">
                <li><a href="#" className="text-slate-800 hover:text-white">Link 1</a></li>
                <li><a href="#" className="text-slate-800 hover:text-white">Link 2</a></li>
                <li><a href="#" className="text-slate-800 hover:text-white">Link 3</a></li>
                <li><a href="#" className="text-slate-800 hover:text-white">Link 4</a></li>
              </ul>
            </div>
  </div>
  </div>
  <div  className="basis-1/1 md:basis-1//3">
          ...
          <div className="basis-1/1 mt-8 text-center text-gray-400  w-screen">
