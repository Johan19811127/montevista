...
const Flipbook = () => {
  return (
    ...
    <div className="demoPage"><Image src="/admission policy/6.png" width="650" height="900" alt="admission policy for Monte Vista Primary School - Page 6"></Image></div>
    <div className="demoPage"><Image src="/admission policy/7.png" width="650" height="900" alt="admission policy for Monte Vista Primary School - Page 6"></Image></div>
    <div className="demoPage"><Image src="/admission policy/8.png" width="650" height="900" alt="admission policy for Monte Vista Primary School - Page 6"></Image></div>
</HTMLFlipBook>
