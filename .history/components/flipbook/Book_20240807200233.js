...
const PageCover = React.forwardRef((props, ref) => {
  ...
  class DemoBook extends React.Component {
    ...
    <Page className="demoPage"><Image src="/admission policy/3.png" width="650" height="900" alt="admission policy for Monte Vista Primary School - Page 3"></Image></pPge>
    <Page className="demoPage"><Image src="/admission policy/4.png" width="650" height="900" alt="admission policy for Monte Vista Primary School - Page 4"></Image></div>
    <Page className="demoPage"><Image src="/admission policy/5.png" width="650" height="900" alt="admission policy for Monte Vista Primary School - Page 5"></Image></div>
    <Page className="demoPage"><Image src="/admission policy/6.png" width="650" height="900" alt="admission policy for Monte Vista Primary School - Page 6"></Image></div>
    <Page className="demoPage"><Image src="/admission policy/6.png" width="650" height="900" alt="admission policy for Monte Vista Primary School - Page 6"></Image></div>
    <Page className="demoPage"><Image src="/admission policy/7.png" width="650" height="900" alt="admission policy for Monte Vista Primary School - Page 7"></Image></div>
    <Page className="demoPage"><Image src="/admission policy/8.png" width="650" height="900" alt="admission policy for Monte Vista Primary School - Page 8"></Image></div>
