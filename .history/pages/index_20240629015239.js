...
<div className="row pl-5">
<div className="col-2"><PhoneIphoneIcon /></div>
<div className="col-4"><p className="contacttextsml text-start" style={{lineHeight:'1.2'}}>Trading Hours :<br/><small className="subtext" style={{}}>(Clothing Store)</small></p></div>
