...
export default function Home() {
  return (
    <main>
      ...
      <p className>Located in the the Beutifull suburb ofg Monte Vista in Cape Town South Africa ,is a primary School which has been a important part of this community for more than 60 years</p>
      </div>
      </div>
      </div>
    </main>
