  ...
  return (
    <main>
      ...
      <div className="container">
        ...
        <div className="row hvh100 ">
          <div className="col-md-5 d-flex flex-column align-items-center justify-content-center ps-5 pe-3">
      ...
      <div className="col-md-7 d-flex flex-column align-items-center justify-content-center p-5">
