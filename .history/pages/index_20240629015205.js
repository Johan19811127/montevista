...
<div className="row pl-5">
<div className="col-2"><PhoneIphoneIcon /></div>
<div className="col-4"><p className="contacttextsml text-start" style={{lineHeight:'1.2'}}>Trading Hours :<br/><small className="subtext">(Clothing Store)</small></p></div>
<div className="col-6"><p className="contacttextsml"  style={{lineHeight:'1.1'}}> Tuesdays 07:30am - 08:15am <br/>Wednesday 13:00pm - 14:30pm</p></div>
