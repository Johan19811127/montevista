...
<div className="col-6"><p className="contacttextsml" style={{lineHeight:'1.4'}}> <a href="">7 Huising Avenue<br/>Monte Vista<br/>7460</a></p></div>

</div>
<div className="row pl-5">
<div className="col-2"><PhoneIphoneIcon /></div>
<div className="col-4"><p className="contacttext text-start" style={{lineHeight:'1.1'}}>Trading Hours :<br/><small className="subtext">(Clothing Store)</small></p></div>
