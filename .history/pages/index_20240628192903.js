...
<div className="row pl-5">
<div className="col-2"><PhoneIphoneIcon /></div>
<div className="col-4"><p className="contacttext">Email :<small className="subtext">(main)</small></p></div>
...
<div className="row pl-5">
<div className="col-2"><PhoneIphoneIcon /></div>
<div className="col-4"><p className="contacttext">Email :<small className="subtext">(Account)</small></p></div>
<div className="col-6"><p className="contacttext"> Montevistaprimaryschool@gmail.com</p></div>
