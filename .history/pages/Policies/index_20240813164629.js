...
<Image src='/AdmissionPolicy.png' width='300' height='300' alt='Admission Policy' className='W-full h-auto rounded-2xl max-w-[50vw] '></Image></div>



<div className=" basis-1/1 md:basis-2/3 px-5">
<h2 className="text-3xl font-bold mt-5">Admission Policy</h2>
