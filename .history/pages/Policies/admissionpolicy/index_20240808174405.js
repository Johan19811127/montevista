...
<div className="flex flex-row">
  ...
  <div className="basis-3/4  px-4">
      ...
      <h1 className=" text-2xl md:text-3xl font-bold text-left mb:4 md:text-center">Admission Policy 2023</h1>
<div className="container mxc-"
<address className="text-center">
      <b className="font-bold mr-5">A:</b>
       Huising Avenue, Monte Vista 7460    </address>
        <a href="tel:+27215584637" className="text-center" ><b className="font-bold mr-5 text-center">T:</b>021 558 4637</a><br></br>
       
      <a href="mailto:montevistaprimaryschool@gmail.com" className="text-center"><b className="font-bold mr-5 text-center">E:</b>montevistaprimaryschool@gmail.com</a>
