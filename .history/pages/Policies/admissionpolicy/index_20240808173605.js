...
<div className="flex flex-row">
  ...
  <div className="basis-3/4  px-4">
      <h1 className=" text-xl md:text-4xl font-bold text-left  md:text-center">Monte Vista Primary School </h1>
      <h1 className=" text-2xl md:text-3xl font-bold mb-4 text-left  md:text-center">Admission Policy 2023</h1>
      <address className="mb-8 text-center">
      <b className="font-bold mr-5">A:</b>
       Huising Avenue, Monte Vista 7460<br />      </address>
        <a href="tel:+27215584637" ><b className="font-bold mr-5">T:</b>021 558 4637</a><br />
       
      <a href="mailto:montevistaprimaryschool@gmail.com" className="text-blue-500">montevistaprimaryschool@gmail.com</a>

      </div>
  
</div>
<hr className="divide-solid mt-3 mb-9 divide-slate-800"></hr>0
