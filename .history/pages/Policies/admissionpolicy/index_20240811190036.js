...
<div className="container mx-auto md:px-5">
        ...
        <ul className="space-y-1">
          ...
          <li className="text-default text-justify"><a href="#general1" className="text-slate-800 font-semibold hover:underline">I. General</a></li>
...
<hr className="divide-solid mt-3 mb-9 divide-slate-800"></hr>
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-2" id="provisions">Policy Provisions</h2>
        <div className="mb-4">
