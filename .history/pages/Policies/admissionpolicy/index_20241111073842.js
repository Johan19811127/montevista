...
<div className="container mx-auto md:px-5">
        ...
        <ul className="space-y-1">
          ...
          <li className="text-default text-justify"><a href="#scope" className="text-slate-800 font-semibold hover:underline">5. Scope of Application</a></li>
          <li className="text-default text-justify"><a href="#objectives" className="text-slate-800 font-semibold hover:underline">6. Objectives</a></li>
          <li className="text-default text-justify"><a href="#legislative" className="text-slate-800 font-semibold hover:underline">7. Legislative Framework</a></li>
          <li className="text-default text-justify"><a href="#provisions" className="text-slate-800 font-semibold hover:underline">8. Policy Provisions”</a></li>
          <li className="text-default text-justify"><a href="#roles" className="text-slate-800 font-semibold hover:underline">9. Roles and Responsibilities</a></li>
          <li className="text-default text-justify"><a href="#breach" className="text-slate-800 font-semibold hover:underline">10. Breach of Policy</a></li>
          <li className="text-default text-justify"><a href="#dresolution" className="text-slate-800 font-semibold hover:underline">11. Dispute Resolution</a></li>
          <li className="text-default text-justify"><a href="#review" className="text-slate-800 font-semibold hover:underline">12. Review of Policy</a></li>
