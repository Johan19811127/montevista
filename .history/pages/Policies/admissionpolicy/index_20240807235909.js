...
<div className="flex flex-row">
  ...
  <div class="basis-1/4"><Image src="/School Badge - Own.png" width="180" height="180" alt="Monte Vista Primary School Badge" className="w-[80%] ml-[10%] "></Image></div>
...
<hr className="divide-solid mt-3 mb-9 divide-slate-2=00"></hr>
