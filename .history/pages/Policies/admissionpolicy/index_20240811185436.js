...
<div className="container mx-auto md:px-5">
        ...
        <ul className="space-y-1">
          <li className="text-default text-justify"><a href="#intro" className="text-slate-800 font-semibold hover:underline">A. Introduction and Background</a></li>
          <li className="text-default text-justify"><a href="#definition" className="text-slate-800 font-semibold hover:underline">B. Definition of Terms</a></li>
          <li className="text-default text-justify"><a href="#policy" className="text-slate-800 font-semibold hover:underline">C.Policy Statements</a></li>
          <li className="text-default text-justify"><a href="#purpose" className="text-slate-800 font-semibold hover:underline">D. Purpose</a></li>
          <li className="text-default text-justify"><a href="#tuck-shop" className="text-slate-800 font-semibold hover:underline">E. Scope of Application</a></li>
...
<hr className="divide-solid mt-3 mb-9 divide-slate-800"></hr>
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-2" id="intro">Introduction and Background</h2>
        <p className="mb-4">
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-2" id="defination">Definition of Terms</h2>
        <p className="mb-4">
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-2" id="policy">Policy Statements</h2>
        <p className="mb-4">
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-2" id="purpose">Purpose</h2>
        <p className="mb-4">
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-2" id="roles">Roles and Responsibilities</h2>
        <p className="mb-4">
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-2" id="breachOfPolicy">Breach of Policy</h2>
        <p className="mb-4">
      ...
      <section>
        <h2 className="text-2xl font-semibold mb-2"id="disputeResolution">Dispute Resolution</h2>
        <p className="mb-4">
