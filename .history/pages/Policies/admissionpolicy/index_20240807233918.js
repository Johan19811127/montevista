...
<div className="flex flex-row">
  ...
  <div class="basis-1/3"><Image src="/School Badge - Own.png" width="200" height="200" alt="Monte Vista Primary School Badge"></Image></div>
  <div class="basis-2/3">
      <h1 className="text-4xl font-bold  text-center">Monte Vista Primary School </h1>
