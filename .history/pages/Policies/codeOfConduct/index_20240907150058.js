...
className="flex px-auto align-center justify-center py-3 text-slate-900  font-bold border border-b-yellow-600 border-t-yellow-100 border-l-yellow-100 hover:border-none border-r-yellow-300  shadow-md text-center bg-yellow-400 rounded-lg mx-auto my-3 shadow-md hover:bg-yellow-300 hover:shadow-none focus:outline-none focus:ring-1 focus:ring-yellow-500"
>
