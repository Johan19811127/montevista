...
const CodeOfConduct = () => {
  return (
    ...
    {/* Sidebar */}
    <div className="w-full md:w-1/4 md:h-screen md:sticky md:top-0 lg:w-1/5 md:bg-slate-200 md:border md:border-right-slate-500 p-4">
    <div className="flex flex-col md:flex-row">
...
className="flex px-auto align-center justify-center py-3 text-slate-900  font-bold border border-b-slate-500 border-t-slateborder-r-slate-500 border-t text-center bg-yellow-400 rounded-lg mx-auto my-3 shadow-md hover:bg-yellow-300 hover:shadow-none focus:outline-none focus:ring-2 focus:ring-blue-500"
>
