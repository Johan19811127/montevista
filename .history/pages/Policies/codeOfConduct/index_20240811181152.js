...
className="flex px-auto align-center justify-center py-3 text-slate-900  font-bold border border-bottom-slate-500 text-center bg-yellow-400 rounded-lg mx-auto my-3 shadow-md hover:bg-yellow-300 hover:shadow-none focus:outline-none focus:ring-2 focus:ring-blue-500"
>
