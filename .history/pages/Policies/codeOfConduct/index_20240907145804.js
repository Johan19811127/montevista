...
className="flex px-auto align-center justify-center py-3 text-slate-900  font-bold border border-b-slate-300 border-t-slate-100 border-l-slate-100 hover:border-none border-r-slate-300  text-center bg-yellow-400 rounded-lg mx-auto my-3 shadow-md hover:bg-yellow-300 hover:shadow-none focus:outline-none focus:ring-1 focus:ring-yellow-500"
>
