...
<div className="container mx-auto px-5">
      ...
      <p className="text-sm mb-2 text-center">Click on the links below to jump to the corresponding section in the school rules.</p>
...
<h1 className=" text-2xl md:text-3xl font-bold text-left mb:4 ">Code of Conduct</h1>
