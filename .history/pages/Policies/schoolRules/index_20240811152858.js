...
<div className="md:container mx-auto">
  ...
  className="flex px-6 py-3 text-gray-700 bg-yellow-500 rounded-lg mx-auto my-3 shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
>
