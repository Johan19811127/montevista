...
<div className="container mx-auto md:px-5">
        ...
        <ul className="space-y-1">
          ...
          <li className="text-default text-justify"><a href="#toilets" className="text-slate-800 font-semiboldh over:underline">J. Toilets/Cloakroom Rules</a></li>
          <li className="text-default text-justify"><a href="#hall" className="text-slate-800 font-semiboldh hover:underline">K. Hall</a></li>
