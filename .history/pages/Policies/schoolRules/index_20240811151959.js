...
<div className="md:container mx-auto">
  ...
  className="inline-block px-6 py-3 text-white bg-blue-600 rounded-lg mx-auto my-3 shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
>
