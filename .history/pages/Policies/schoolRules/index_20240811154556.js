...
<div className="container mx-auto">
        ...
        <ul className="space-y-2">
          <li className="text-default text-justify"><a href="#lining-up" className="text-slate-800 text-semiboldhover:underline">A. Lining Up</a></li>
          <li className="text-default text-justify"><a href="#passages" className="text-slate-800 text-semiboldhover:underline">B. Passages</a></li>
          <li className="text-default text-justify"><a href="#classrooms" className="text-slate-800 text-semiboldhover:underline">C. Classrooms</a></li>
          <li className="text-default text-justify"><a href="#playground" className="text-slate-800 text-semiboldhover:underline">D. Playground</a></li>
          <li className="text-default text-justify"><a href="#tuck-shop" className="text-slate-800 text-semiboldhover:underline">E. Tuck Shop</a></li>
          <li className="text-default text-justify"><a href="#absenteeism" className="text-slate-800 text-semiboldhover:underline">F. Absenteeism</a></li>
          <li className="text-default text-justify"><a href="#cell-phones" className="text-slate-800 text-semiboldhover:underline">G. Cell Phones / Electronic Devices</a></li>
          <li className="text-default text-justify"><a href="#dress-code" className="text-slate-800 text-semiboldhover:underline">H. Dress Code and “Civvies Day”</a></li>
          <li className="text-default text-justify"><a href="#general" className="text-slate-800 text-semiboldhover:underline">I. General</a></li>
          <li className="text-default text-justify"><a href="#toilets" className="text-slate-800 text-semiboldhover:underline">J. Toilets/Cloakroom Rules</a></li>
          <li className="text-default text-justify"><a href="#hall" className="text-slate-800 text-semiboldhover:underline">K. Hall</a></li>
          <li className="text-default text-justify"><a href="#foyer" className="text-slate-800 text-semiboldhover:underline">L. Foyer</a></li>
          <li className="text-default text-justify"><a href="#administrative-area" className="text-slate-800 text-semiboldhover:underline">M. Administrative Area</a></li>
          <li className="text-default text-justify"><a href="#after-hours" className="text-slate-800 text-semiboldhover:underline">N. School Building After Hours</a></li>
        </ul>
      </div>
      </div>
      {/* Main Content */}
