...
<div className=" w-1/1 md:w-1/5"><Image src="/Badge.png" width="180" height="180" alt="Monte Vista Primary School Badge" className=" mx-auto max-w-[30vw] w-[80%]  "></Image></div>
<div className=" w-1//1 md:w-4/5  ">
<div className="md:container mx-auto">
  <h1 className=" text-lg font-bold text-left ">Monte Vista Primary School </h1>
  <h1 className=" text-2xl  font-bold text-left mb:4 ">School Rules</h1>
  ...
  className="inline-block px-6 py-3 text-white bg-blue-600 rounded-lg mx-0aoto my-3 shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500"
>
