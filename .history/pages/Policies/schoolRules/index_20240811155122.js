...
<div className="container mx-auto md:pl-5">
        ...
        <p className="text-sm mb-5 tecxt">Click on the links below to jump to the corresponding section in the school rules.</p>
        <ul className="space-y-1">
          <li className="text-default text-justify"><a href="#lining-up" className="text-slate-800 font-semiboldhover:underline">A. Lining Up</a></li>
          <li className="text-default text-justify"><a href="#passages" className="text-slate-800 font-semiboldhover:underline">B. Passages</a></li>
          <li className="text-default text-justify"><a href="#classrooms" className="text-slate-800 font-semiboldhover:underline">C. Classrooms</a></li>
          <li className="text-default text-justify"><a href="#playground" className="text-slate-800 font-semiboldhover:underline">D. Playground</a></li>
          <li className="text-default text-justify"><a href="#tuck-shop" className="text-slate-800 font-semiboldhover:underline">E. Tuck Shop</a></li>
          <li className="text-default text-justify"><a href="#absenteeism" className="text-slate-800 font-semiboldhover:underline">F. Absenteeism</a></li>
          <li className="text-default text-justify"><a href="#cell-phones" className="text-slate-800 font-semiboldhover:underline">G. Cell Phones / Electronic Devices</a></li>
          <li className="text-default text-justify"><a href="#dress-code" className="text-slate-800 font-semiboldhover:underline">H. Dress Code and “Civvies Day”</a></li>
          <li className="text-default text-justify"><a href="#general" className="text-slate-800 font-semiboldhover:underline">I. General</a></li>
          <li className="text-default text-justify"><a href="#toilets" className="text-slate-800 font-semiboldhover:underline">J. Toilets/Cloakroom Rules</a></li>
          <li className="text-default text-justify"><a href="#hall" className="text-slate-800 font-semiboldhover:underline">K. Hall</a></li>
          <li className="text-default text-justify"><a href="#foyer" className="text-slate-800 font-semiboldhover:underline">L. Foyer</a></li>
          <li className="text-default text-justify"><a href="#administrative-area" className="text-slate-800 font-semiboldhover:underline">M. Administrative Area</a></li>
          <li className="text-default text-justify"><a href="#after-hours" className="text-slate-800 font-semiboldhover:underline">N. School Building After Hours</a></li>
        </ul>
      </div>
      </div>
      {/* Main Content */}
