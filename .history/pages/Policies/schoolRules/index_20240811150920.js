...
<div className=" w-1/1 md:w-1/6"><Image src="/Badge.png" width="180" height="180" alt="Monte Vista Primary School Badge" className=" mx-auto max-w-[30vw] w-[80%]  "></Image></div>
<div className=" w-1//1 md:w-5/6  px-4">
<div className="md:container mx-auto">
  <h1 className=" text-2xl md:text-2xl font-bold text-left ">Monte Vista Primary School </h1>
  <h1 className=" text-2xl md:text-2xl font-bold text-left mb:4 ">Admission Policy 2023</h1>
