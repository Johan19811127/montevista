...
export default function ourteam() {
  return (
    <main>
        ...
        <h1 className="text-6xl font-bold text-blue-800 my-10 text-center">Extra Mural program at Monte Vista Primary School</h1>

        <p className="text-blue-800 mx-6 leading tight my-4">
...
<p className="text-blue-800 mx-6 my-4 text-2xl font-bold">Our summer program consist of the following:</p>
<Tennis></Tennis>
<Cricket></Cricket>
<Athletics></Athletics>
