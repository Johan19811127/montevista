...
export default function ourteam() {
  return (
    <main>
        ...
        <p className="text-blue-800 mx-6 leading tight my-4 text-justify">
...
<p className="text-blue-800 mx-6  text-justify my-4">
...
<p className="text-textwhite mx-6 my-4 text-2xl font-bold text-center">Our summer program consist of the following:</p>
</div>
<Tennis></Tennis>
<Cricket></Cricket>
<Athletics></Athletics>
