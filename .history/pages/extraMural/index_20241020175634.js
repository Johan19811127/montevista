...
import Netbal from '@/components/sport/Netbal'
...
export default function ourteam() {
  return (
    <main>
         <div className="container max-w-8xl mx-auto p-5 bg-white my-5">
          <div className="bg-blue-800 p-4">
        <h1 className="text-4xl font-bold text-white my-10 text-center">Extra Mural program at Monte Vista Primary School</h1>

        <p className="text-white mx-6 leading-tight my-4 text-justify">
...
<p className="text-white mx-6  leading-tight text-justify my-4">
