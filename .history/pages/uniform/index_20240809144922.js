...
<div className="basis-1/2 md:basis-2/3  px-4">
    ...
    >
      ...
      <h2 className="text-3xl font-bold text-center text-white my-4">Prescribed Uniform for Learners in Grade 1 to 7</h2>
...
<div className="flex flex-col  md:flex-row">
   ...
   <li className="text-default  font-md text-center text-wqhite">grey pants (long or short) </li>
   ...
   <li className="text-default  font-md text-center text-white">Long grey pants </li>
   <li className="text-default font-md text-center text-white">white Long-sleeved shirt.</li>

   <li className="text-default font-md text-center text-white">Monte Vista Tie.</li>
