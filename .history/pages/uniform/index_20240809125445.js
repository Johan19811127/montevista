...
<div className="flex flex-row">
    ...
    <Image src="/summer.png" width="200" height="150" alt="Summer Uniform for Boys" className="w-[70%] h-auto  ml-[15%] mt-10"></Image>
   <h3 className="text-3xl text-center font-black text-yellow-300">SUMMER</h3>
    <p className="text-xl font-bold text-center leading-tight mb-0">UNIFORM FOR BOYS<br></br>(1st and 4th term)</p>
   <ul className="list-disc my-8 ml-4">

   <li className="text-default font-md text-center"> black school shoes</li> 
   <li className="text-default  font-md text-center">long grey school socks</li>
   <li className="text-default  font-md text-center">grey pants (long or short) </li>
   <li className="text-default font-md text-center">white short-sleeved open-neck shirt.</li>
