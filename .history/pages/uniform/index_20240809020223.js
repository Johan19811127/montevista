...
<div className=" basis-1/3 lg:basis-1/2"><Image src="/Uniform.png" width="280" height="280" alt="Monte Vista Primary School Badge" className="w-[90%] ml-[5%] lg:w-[70%] lg:ml-[15%] "></Image></div>
