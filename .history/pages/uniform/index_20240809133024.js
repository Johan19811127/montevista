...
<div className="flex flex-row">
    <div className="md:basis-1/2 bg-blue-400 py-0">
    <div className="flex flex-row">
   ...
   <h3 className="text-5xl text-center font-black text-yellow-400">SUMMER</h3>
    <p className="text-xl font-bold text-center leading-tight mb-0 text-yellow-400">UNIFORM FOR BOYS<br></br>(1st and 4th term)</p>
