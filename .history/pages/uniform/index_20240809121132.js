...
<p className="text-default mx-5 text-justify leading tioght">School uniform plays an important role in a learner’s school career. Besides creating basic uniformity and equality in the school, it also helps the learner to develop a sense of pride in his/her school. It is thus necessary for each learner to be correctly and neatly attired every school day.</p>
     <h2 className="text-3xl font-bold text-center my-4">Prescribed Uniform for Learners in Grade 1 to 7</h2>
<div className="flex flex-row">
    <div className="md:basis-1/2">
    <div className="flex flex-row">
    <div className="basis-1/2">
    <Image src="/summerboy.png" width="200" height="350" alt="boy uniform in summer" className="w-100 h-auto mt-5"></Image>
    ...
    <Image src="/summer.png" width="200" height="150" alt="Summer Uniform for Boys" className="w-[70%] h-auto  ml-[15%]"></Image>
    <p className="text-lg font-bold text-center leading-tight mb-0">UNIFORM FOR BOYS<br></br>(1st and 4th term)</p>
   <ul className="list-disc my-8 ml-4">

   <li className="text-default font-bold"> black school shoes</li> 
   <li className="text-default  font-bold">long grey school socks</li>
   <li className="text-default  font-bold">grey pants (long or short) </li>
   <li className="text-default font-bold">white short-sleeved open-neck shirt.</li>
