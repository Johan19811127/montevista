...
<div className="basis-1/3"><Image src="/Uniform.png" width="280" height="280" alt="Monte Vista Primary School Badge" className="w-[90%] ml-[5%] "></Image></div>
<div className="basis-3/3  px-4">
