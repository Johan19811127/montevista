...
<div className="flex flex-row">
   ...
   <li className="text-default font-md text-center text-yellow-300"> black school shoes</li> 
   <li className="text-default  font-md text-center text-yellow-300">long grey school socks</li>
   <li className="text-default  font-md text-center text-yellow-300">grey pants (long or short) </li>
   <li className="text-default font-md text-center text-yellow-300">white short-sleeved open-neck shirt.</li>
