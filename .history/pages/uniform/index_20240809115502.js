...
<div className="flex flex-row">
    ...
    <p className="text-default font-bold text-center leading-tight mb-0">UNIFORM FOR BOYS</p>
    <p clkasName="text-default font-semibold text-center leading-tight mb-0">(1st and 4th term)</p>
