...
<div className="flex flex-row">
    ...
    <Image src="/summer.png" width="200" height="150" alt="Summer Uniform for Boys" className="w-[70%] h-auto mb-3 ml-[15%]"></Image>
    <p className="text-default font-bold">UNIFORM FOR BOYS</p>
