...
<div className="flex flex-col-reverse  md:flex-row">
   ...
   <li className="text-default font-md text-center text-blue-700">Monte Vista Tie.</li>
    ...
    <div className="flex flex-row">
    <div className="basis-1/2">
    <Image src="/summergirl.png" width="200" height="350" alt="boy uniform in summer" className="w-100 h-auto"></Image>
   ...
   <div className="flex flex-col-reverse  md:flex-row">
    ...
    <Image src="/summer.png" width="200" height="150" alt="Summer Uniform for Boys" className="w-[50%] h-auto  ml-[25%] mt-2"></Image>
   <h3 className="text-4xl text-center font-black text-yellow-300">SUMMER</h3>
    <p className="text-lg font-bold text-center leading-tight mb-0 text-yellow-300">SPORTS CLOTHES FOR BOYS<br></br>(1st and 4th term)</p>
   <ul className="list-disc my-2 ml-4">
