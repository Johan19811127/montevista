...
<div className="row pl-5">
<div className="col-2"><PhoneIphoneIcon /></div>
<div className="col-4"><p className="contacttext" style={{lineheight:'1.1'}}>Email :<small className="subtext">(main)</small><br></br>Email :<small className="subtext">(School Fees)</small>,</p></div>
